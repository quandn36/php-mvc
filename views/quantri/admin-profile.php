<div id="user-profile-2" class="admin-profile">
	<div class="tabbable">
...
<style>
	...
	.admin-profile .ace-thumbnails li {
		border: 1px solid #CCC;
		padding: 3px;
		margin: 6px
	}

	.admin-profile .ace-thumbnails li .tools {
		left: 3px;
		right: 3px
	}

	.admin-profile .ace-thumbnails li:hover .tools {
		bottom: 3px
	}
