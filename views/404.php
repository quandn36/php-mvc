...
<html>
<head>
<title>404 Khong tìm thấy trang</title>
<!-- for-mobile-apps -->
  ...
  <div class="main">
    <div class="agileits_main_grid">
      <div class="agileits_main_grid_left">
        <h1>404 không tìm thấy trang</h1>
      </div>
      <div class="agileits_main_grid_right">
        <a href="index.php?controller=hethongController&action=index">Quay lại trang chủ</a>
      </div>
      <div class="clear"> </div>
    </div>
    ...
    <div class="agile_copy_right">
      <p>&copy; Bản quyền thuộc về Ngọc Quân <i class="fa fa-heart"></i> <a href="#"></a></p>
    </div>
  </div>
</body>
</html>