...
<style>
  ...
  * + html .fileinput-button {
  ...
  @media (max-width: 767px)     .files .btn span {
      display: none;
    }
    .files .preview * {
      width: 40px;
  ...
  <div class="mail-box">
    <aside class="sm-side">
      ...
      <div class="inbox-body">
        <a data-toggle="modal" data-target="#myModal"  title="Compose"  class="btn btn-compose">
          Compose
        </a>
      </div>
    ...
    <aside class="lg-side">
      ...
      <div class="inbox-body">
       ...
       <table class="table table-inbox table-hover" id="table_inbox_admin">
        <tbody>
          <tr class="unread">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="yyexampleModalLabel">Thư mới</h5>
      ...
      <div class="modal-body">
        <form role="form" method="post" id="reused_form">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" type="textarea" name="message" id="message" placeholder="Viết gì đó..." maxlength="6000" rows="7"></textarea>
          </div>
          <button type="submit" class="btn btn-lg btn-success btn-block" id="btnContactUs">Gửi thư</button>
        </form>
