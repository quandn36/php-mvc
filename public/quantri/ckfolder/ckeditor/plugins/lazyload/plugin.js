...
(function() {
   ...
   CKEDITOR.plugins.add('lazyloadi', {
     
      requires : [ 'iframe', 'dialog' ], 
      icons: 'socialbox',
            ...
            elements : [
               {
                  id : 'lazyLoadCheck',
                  type : 'checkbox',
                  label : 'Apply lazy loading to this iframe?',
                  ...
                  onChange: function() {
                     ...
                     var element = dialog.getSelectedElement();
                     var blnChecked = this.getValue();
					 var original = dialog.iframeNode;
                     dialog.dontResetSize = true;
               ...
               },
               {
                  id : 'lazyLoadDataOrig',
                  type : 'text',
                  label : 'The iframe url for lazy loading (attribute data-src).',
                  setup : function( element) {
