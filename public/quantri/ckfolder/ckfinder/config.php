...
*/
$baseUrl = 'public/quantri/ckfolder/images/';
...
ATTENTION: The trailing slash is required.
*/
$baseDir = 'C:\xampp\htdocs\admin\public\quantri\ckfolder\images/'; //resolveUrl($baseUrl);
...
$config['ResourceType'][] = array(
	...
	'maxSize' => 0,
	'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,ico,svg',
	'deniedExtensions' => ''
);
